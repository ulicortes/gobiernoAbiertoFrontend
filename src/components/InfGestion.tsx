export default function InfGestion() {
    return <div className="w-full h-36 bg-green-500 rounded-tr-3xl rounded-bl-3xl flex-flex-col justify-center content-center">
        ...
        <div className="w-full h-1/2 flex flex-row justify-evenly">
            <div className="w-fit h-fit px-2 bg-slate-200 rounded-md text-black text-center flex flex-col">
                <h1 className="text-2xl">2022</h1>
                <h1 className="text-sm">INFORME DE GESTION</h1>
            </div>
            <div className="w-fit h-fit px-2 bg-slate-200 rounded-md text-black text-center flex flex-col">
