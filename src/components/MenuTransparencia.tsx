...
export default function MenuTransparencia() {
    ...
    return <div className="w-2/3 h-80 bg-[#BFEEFF] border-4. border-blue-dark shadow-xl shadow-black px-4 rounded-lg text-black text-center flex flex-col justify-evenly items-center">
