...
export default function ContactSection({ onContactClick }: ContactSectionProps) {
  return (
    <section className="w-full py-10 pb-20 bg-white">
      <div className="py-12 px-8 bg-green-base from-green-base to-green-light flex flex-col items-center justify-center gap-8">
