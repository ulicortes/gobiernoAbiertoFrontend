            ...
            <div className={`fixed top-24 right-0 z-50 w-64 bg-black-base border-l-4 border-b-4 rounded-bl-4xl transition-all duration-300 ease-in-out md:hidden ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} ${getBorderColor()}`}>
                <div className="flex flex-col items-center py-4">
                    <Link href={'/transparencia'}>
                        <h1 className={`w-fit py-3 text-center font-bold`}>TRANSPARENCIA</h1>
                    </Link>
                    <Link href={'/'}>
                        <h1 className="w-fit py-3 text-center font-bold">DATOS ABIERTOS</h1>
                    </Link>
                    <Link href={'https://sibom.slyt.gba.gob.ar/cities/73'}>
                        <h1 className="w-fit py-3 text-center font-bold">BOLETIN OFICIAL</h1>
                    </Link>
                </div>
